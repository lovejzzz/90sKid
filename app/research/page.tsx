    ...
    <>
      ...
      <main className="paper-page wrap">
        ...
        <div className="paper-layout">
          <aside className="paper-toc"><b>目录</b><a href="#premise">1　研究命题</a><a href="#layers">2　多层乳剂</a><a href="#grain">3　颗粒与染料云</a><a href="#mask">4　有色遮罩</a><a href="#dir">5　DIR层间效应</a><a href="#scanner">6　扫描器耦合</a><a href="#black">7　黑位与高光</a><a href="#v21">8　V21结果</a><a href="#limitations">9　边界</a><a href="#references">引用</a></aside>

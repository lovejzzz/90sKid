  ...
  return (
    <>
      ...
      <main className="archive-page wrap">
        <header className="page-header"><span className="eyebrow">VERSION ARCHIVE · V4—{latest}</span><h1>{text(<>每一次变好，<br />也记录为什么曾经出错。</>, <>Every improvement records<br />why the earlier result was wrong.</>)}</h1><p>{text("V39把5279与2383的图像结构放回负片和印片密度域；颜色、黑位、gamma与V38双交付保持冻结。", "V39 moves 5279 and 2383 image structure into negative and print density while freezing V38 colour, black, gamma and dual delivery.")}</p></header>

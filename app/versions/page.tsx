  ...
  return (
    <>
      ...
      <main className="archive-page wrap">
        <header className="page-header"><span className="eyebrow">VERSION ARCHIVE · V4—V25</span><h1>每一次变好，<br />也记录为什么曾经出错。</h1><p>V25继续使用两段GH7 Open Gate ProRes RAW素材，把胶片物理、影院观察、Rec.709交换母版、BT.1886参考显示与网页sRGB分开验证，并记录第一次V25提亮错误和无降质加速的真实计时；早期版本缺失的分支仍会明确标注为共用或沿用。</p></header>

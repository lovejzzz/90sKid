  ...
  return (
    <>
      ...
      <main className="archive-page wrap">
        <header className="page-header"><span className="eyebrow">VERSION ARCHIVE · V4—V22</span><h1>每一次变好，<br />也记录为什么曾经出错。</h1><p>所有截图来自同一组GH7 Open Gate ProRes RAW测试素材。早期版本尚未拆分放映和蓝光路径；缺失分支会明确标注为共用实验图或沿用上一版。</p></header>

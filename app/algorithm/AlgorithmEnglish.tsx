...
export function AlgorithmEnglish() {
  return (
    <main className="algorithm-page wrap">
      <header className="page-header"><span className="eyebrow">METHOD · CURRENT V29</span><h1>Not a filter.<br />An image-formation chain.</h1><p>V28 corrects the ProRes RAW input-primary contract. V29 adds no creative grade: it extends both observers from the same negative into complete motion and validates pixels, temporal grain, audio, timecode and 12-bit delivery.</p></header>
      ...
      <section className="validation"><span className="section-tag">V29 FULL-MOTION VALIDATION</span><h2>Complete T002 release gates</h2><div className="validation-grid"><div><b>Complete motion</b><p>165 / 165 frames</p></div><div><b>Segment parity</b><p>Frame 82 bit-exact RGB48</p></div><div><b>Hard white clipping</b><p>Zero in both observers</p></div><div><b>Temporal stochasticity</b><p>New emulsion every frame</p></div><div><b>Audio / timecode</b><p>24-bit · 4ch · 12:04:05:23</p></div><div><b>Output</b><p>5760×4320 · 12-bit · Rec.709 1-1-1</p></div></div></section>
    </main>
  );
}
